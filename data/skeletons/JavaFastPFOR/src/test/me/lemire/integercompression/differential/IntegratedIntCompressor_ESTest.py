...
# from src.test.me.lemire.integercompression.differential.IntegratedIntCompressor_ESTest_scaffolding import *
...
class IntegratedIntCompressor_ESTest(unittest.TestCase):
