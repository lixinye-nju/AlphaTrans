...
# from src.test.me.lemire.integercompression.differential.SkippableIntegratedComposition_ESTest_scaffolding import *
...
class SkippableIntegratedComposition_ESTest(unittest.TestCase):
