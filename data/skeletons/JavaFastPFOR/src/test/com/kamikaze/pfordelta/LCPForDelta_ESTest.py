...
# from src.test.com.kamikaze.pfordelta.LCPForDelta_ESTest_scaffolding import *
from src.main.com.kamikaze.pfordelta.LCPForDelta import *
import unittest
import io
...
class LCPForDelta_ESTest(unittest.TestCase):
