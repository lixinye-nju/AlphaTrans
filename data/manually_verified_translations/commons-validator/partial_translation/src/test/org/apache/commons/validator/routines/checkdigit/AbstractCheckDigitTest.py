...
class AbstractCheckDigitTest(unittest.TestCase, ABC):
    ...
    _invalid: typing.List[typing.List[str]] = [["12345678A"]]
    ...
    def testMissingCode(self) -> None:
        ...
        try:
            ...
            self.assertEqual(self._missingMessage, e.getMessage(), "calculate() Null")
        ...
        try:
            ...
            self.assertEqual(
                self._missingMessage, e.getMessage(), "calculate() Zero Length"
            )
