...
class EmailValidatorTest(unittest.TestCase):
    ...
    def testValidator473_4(self) -> None:
        ...
        items = [Item(ArrayType.GENERIC_PLUS, ["local"])]
    ...
    def testEmailWithSlashes(self) -> None:
        ...
        self.assertFalse(
            self.__validator.isValid("joe@ap/ache.org"), "/ not valid in domain"
        )
        self.assertFalse(
    ...
    def testEmailLocalhost(self) -> None:
        ...
        self.assertFalse(
            noLocal.isValid("joe@localhost"), "@localhost should be accepted but wasn't"
        )
