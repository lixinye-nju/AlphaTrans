...
class OptionTest(unittest.TestCase):
    ...
    def testHashCode(self) -> None:
        ...
        assert (
            Builder.builder1("test").build().hashCode()
            != Builder.builder1("test2").build().hashCode()
        )
        assert (
            Builder.builder1("test").build().hashCode()
            != Builder.builder0().longOpt("test").build().hashCode()
        )
        assert (
            Builder.builder1("test").build().hashCode()
            != Builder.builder1("test").longOpt("long test").build().hashCode()
        )
    ...
    def testBuilderMethods(self) -> None:
        ...
        self.__checkOption(
            Builder.builder1("a").desc("desc").build(),
            "a",
            "desc",
            None,
        ...
        self.__checkOption(
            Builder.builder1("a").desc("desc").longOpt("aaa").build(),
            "a",
            "desc",
            "aaa",
            Option.UNINITIALIZED,
        ...
        self.__checkOption(
            Builder.builder1("a").desc("desc").hasArg1(True).build(),
            "a",
            "desc",
            None,
            1,
        ...
        self.__checkOption(
            Builder.builder1("a").desc("desc").hasArg1(False).build(),
            "a",
            "desc",
            None,
            Option.UNINITIALIZED,
        ...
        self.__checkOption(
            Builder.builder1("a").desc("desc").numberOfArgs(3).build(),
            "a",
            "desc",
            None,
            3,
        ...
        self.__checkOption(
            Builder.builder1("a").desc("desc").required1(True).build(),
            "a",
            "desc",
            None,
            Option.UNINITIALIZED,
        ...
        self.__checkOption(
            Builder.builder1("a").desc("desc").required1(False).build(),
            "a",
            "desc",
            None,
            Option.UNINITIALIZED,
        ...
        self.__checkOption(
            Builder.builder1("a").desc("desc").argName("arg1").build(),
            "a",
            "desc",
            None,
            Option.UNINITIALIZED,
        ...
        self.__checkOption(
            Builder.builder1("a").desc("desc").optionalArg(False).build(),
            "a",
            "desc",
            None,
            Option.UNINITIALIZED,
        ...
        self.__checkOption(
            Builder.builder1("a").desc("desc").optionalArg(True).build(),
            "a",
            "desc",
            None,
            Option.UNINITIALIZED,
        ...
        self.__checkOption(
            Builder.builder1("a").desc("desc").valueSeparator1(":").build(),
            "a",
            "desc",
            None,
            Option.UNINITIALIZED,
        ...
        self.__checkOption(
            Builder.builder1("a").desc("desc").type_(int).build(),
            "a",
            "desc",
            None,
            Option.UNINITIALIZED,
        ...
        self.__checkOption(
            Builder.builder0().option("a").desc("desc").type_(int).build(),
            "a",
            "desc",
            None,
            Option.UNINITIALIZED,
