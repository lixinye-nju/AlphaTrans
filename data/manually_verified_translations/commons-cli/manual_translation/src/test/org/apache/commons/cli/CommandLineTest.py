...
import io
import unittest
from src.main.org.apache.commons.cli.CommandLine import CommandLine, Builder as CommandLineBuilder
...
from src.main.org.apache.commons.cli.Option import Option
...
class CommandLineTest(unittest.TestCase):
    ...
    def testGetOptionPropertiesWithOption(self) -> None:
        ...
        assert props.get("param1", None) == "value1", "property 1"
        assert props.get("param2", None) == "value2", "property 2"
        assert props.get("param3", None) == "true", "property 3"
        assert props.get("param4", None) == "value4", "property 4"

        assert (
            cl.getOptionProperties0(optionProperty).get("foo", None) == "bar"
    ...
    def testGetOptionProperties(self) -> None:
        ...
        assert (
            cl.getOptionProperties1("property").get("foo", None) == "bar"
        ), "property with long format"
