...
class OptionsTest(unittest.TestCase):
    ...
    def testMissingOptionsException(self) -> None:
        ...
        try:
            ...
            self.assertEqual("Missing required options: f, x", str(e))
    ...
    def testMissingOptionException(self) -> None:
        ...
        try:
            ...
            self.assertEqual("Missing required option: f", str(e))
    ...
    def testDuplicateSimple(self) -> None:
        ...
        self.assertEqual(
            "toggle -a*", opts.getOption("a").getDescription(), "last one in wins"
        )
