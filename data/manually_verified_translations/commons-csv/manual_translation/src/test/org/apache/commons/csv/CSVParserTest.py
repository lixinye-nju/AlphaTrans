...
class CSVParserTest(unittest.TestCase):
    ...
    __CSV_INPUT_NO_COMMENT: str = "A,B" + Constants.CRLF + "1,2" + Constants.CRLF
    ...
    def testParseUrlCharsetNullFormat(self) -> None:
        ...
        with pytest.raises((TypeError, AttributeError, ValueError)):
            CSVParser.parse5(
                url=urlparse("https://commons.apache.org"),
    ...
    def testParserUrlNullCharsetFormat(self) -> None:
        ...
        with pytest.raises((TypeError, AttributeError, ValueError)):
            CSVParser.parse5(urlparse("https://commons.apache.org"), None, CSVFormat.DEFAULT)

    def testParseNullUrlCharsetFormat(self) -> None:

        with pytest.raises((TypeError, AttributeError, ValueError)):
            CSVParser.parse(None, locale.getpreferredencoding(), CSVFormat.DEFAULT)
    ...
    def testParseNullPathFormat(self) -> None:
        ...
        with pytest.raises((TypeError, AttributeError, ValueError)):
            CSVParser.parse2(None, locale.getpreferredencoding(), CSVFormat.DEFAULT)

    def testParseNullFileFormat(self) -> None:

        with pytest.raises((TypeError, AttributeError, ValueError)):
            CSVParser.parse0(None, locale.getpreferredencoding(), CSVFormat.DEFAULT)
    ...
    def testGetOneLineOneParser(self) -> None:
        ...
        try:
            ...
            writer.write(format_.getRecordSeparator())
    ...
    @unittest.skip("PR 295 does not work")
    ...
    def testCSV141CSVFormat_ORACLE(self) -> None:
        ...
        parser = CSVParser.parse2(path, self.__UTF_8, CSVFormat.ORACLE)
        try:
    ...
    def __testCSV141Ok(self, format_: CSVFormat) -> None:
        ...
        parser = CSVParser.parse2(path, self.__UTF_8, format_)
        try:
            record = parser.nextRecord()
            self.assertEqual("1414770317901", record.get1(0))
            self.assertEqual("android.widget.EditText", record.get1(1))
